            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="feature-box text-center px-4 py-5">
                            <div class="text-primary feature-icon mb-3">
                                <div class="progress mx-auto" id="ph" data-value='0' data-max='100'> <span class="progress-left"> <span class="progress-bar border-primary"></span> </span> <span class="progress-right"> <span class="progress-bar border-primary"></span> </span>
                                    <div class="progress-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
                                        <div class="h2 font-weight-bold" id="data">0</div>
                                    </div>
                                </div>
        ...
        <script>
			...
			$(document).ready(function() {
                ...
                $('#loadChart').click((e) => {
                    ...
                    const chart5 = Chart.getChart("phChart");
                    if (chart) { 
                        chart.destroy();
                        chart1.destroy();
                        chart2.destroy();
                    ...
                    $.ajax({
                        url: 'function.php?action=chart&type=pertumbuhan',
                        type: 'get',
                        data: {
                            month: val
                        },
                        ...
                        success: (response) => {
                            ...
                            //Kelembapan Udara
                            let humAirChart = $('#humAirChart')[0].getContext('2d');
                            ...
                            //Kelembapan Tanah
                            let humSoilChart = $('#humSoilChart')[0].getContext('2d');
				...
				(async () => {
					while(true){
						$.ajax({
							url: 'function.php?action=latest&type=pertumbuhan',
							type: 'get',
							dataType:'json',
							success: (data) => {
								//console.log(data)
								...
								$('#ph').attr('data-value', data.ph).find('#data').text(data.ph)
