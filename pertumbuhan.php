...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Sistem Monitoring Smart Green House Melon</title>
    ...
    <body>
        ...
        <script>
            ...
            const pindah = (e) => {
                e.preventDefault()
                location.href = 'dashboard.php?type=pembibitan'
            }
                                    ...
                                    datasets: [
                                        {
                                            ...
                                            borderColor: 'rgba(55, 125, 113, 0.5)',
                                            backgroundColor: 'rgba(55, 125, 113, 1)'
                                        }
                                    ]
                                },
                                options: {
